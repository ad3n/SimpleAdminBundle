                ...
                ->arrayNode('themes')
                    ...
                    ->children()
                        ...
                        ->scalarNode('change_password')
                            ->defaultValue('IhsanSimpleAdminBundle:Index:change_password.html.twig')
                        ->end()
                        ->scalarNode('form_theme')
                            ->defaultValue('IhsanSimpleAdminBundle:Form:fields.html.twig')
                        ->end()
                        ->scalarNode('new_view')
                            ->defaultValue('IhsanSimpleAdminBundle:Crud:new.html.twig')
                        ->end()
                        ->scalarNode('edit_view')
                            ->defaultValue('IhsanSimpleAdminBundle:Crud:new.html.twig')
                        ->end()
                        ->scalarNode('show_view')
                            ->defaultValue('IhsanSimpleAdminBundle:Crud:show.html.twig')
                        ->end()
                        ->scalarNode('list_view')
                            ->defaultValue('IhsanSimpleAdminBundle:Crud:list.html.twig')
                        ->end()
